...
def get_args() -> dict:
    ...
    # path
    parser.add_argument('--inputs_path', type=str, default='/home/liuhaotian/datasm/gtest_lht/')#test_LandBench test
    ...
    parser.add_argument('--niter', type=float, default=200) #200
